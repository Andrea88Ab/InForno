    ...
    public class HomeController : Controller
    {
        ...
        public List<SelectListItem> a
        {
            get
            {
                ...
                {
                    string formattedPrice = agg.Prezzo.ToString("N2", CultureInfo.GetCultureInfo("it-IT"));
                    SelectListItem item = new SelectListItem { Text = $"{agg.Nome} (€{formattedPrice})", Value = agg.IdAggiunzione.ToString() };
